...
const features = [
  {
    ...
    description: (
      <>
        参加者を 京大・阪大・神大の学部生および大学院生 に限定。<br />
        同じような志を持つ、レベルの高い仲間と出会える貴重な機会です。
      </>
    ),
    icon: Users,
  },
  {
    ...
    description: (
      <>
        業界をリードするトップ企業のみを厳選して招待。<br />
        一度に複数の優良企業と深く接点を持って現場社員様と深く話せる効率的なイベントです。
      </>
    ),
    icon: Building2,
  },
  {
    ...
    description: (
      <>
        通常の選考ルートとは異なる、イベント参加者限定の特別選考パス獲得のチャンスです。<br />
        効率的に就職活動を進めることができます。
      </>
    ),
    icon: TrendingUp,
